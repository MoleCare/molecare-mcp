 ...
 * `molecare://ontology/*` resources in `src/index.ts`. The educational prose
...
export const TERMINOLOGY_PROVENANCE = {
  snomedCt: {
    ...
    note:
      "Concept identifiers and fully specified names were checked against the SNOMED International browser. This package ships a small educational subset only — not a licensed terminology release. Plain-English search aliases are written for this package and are not SNOMED CT descriptions.",
    redistribution:
